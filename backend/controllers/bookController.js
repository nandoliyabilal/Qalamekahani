...
const getBooks = asyncHandler(async (req, res) => {
    ...
    const mappedData = data.map(book => ({
        ...book,
        price: book.discount_price || book.price || 0,
        discounted_price: book.discount_price || 0
    }));
...
const getBookById = asyncHandler(async (req, res) => {
    ...
    // Map price fields to ensure frontend compatibility
    book.price = book.discount_price || book.price || 0;
    book.discounted_price = book.discount_price || 0;
